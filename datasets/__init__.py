...
from .coco import build_RGBT_KAIST, build_RGBT_GIR
...
def build_dataset(image_set, args):
    ...
    if args.dataset_file == 'kaist_fusion':
        return build_RGBT_KAIST(image_set, args)
    if args.dataset_file == 'gir_fusion':
        return build_RGBT_GIR(image_set, args)
